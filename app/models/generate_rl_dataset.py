...
generator.load_state_dict(torch.load('rl_generator.pth', map_location=device))
generator.eval()

out_dir = '../../data/severstal/rl_synthetic'
...
with torch.no_grad():
    for class_name, cond in class_conditions.items():
        ...
        for i in range(n_per_class):
            fname = f'{class_name}_rl_synthetic_{i}.png'
...
synthetic_labels.to_csv('../../data/severstal/rl_synthetic_labels.csv', index=False)
