...
train_labels = pd.read_csv('../../data/severstal/train_split_vae_augmented.csv')
...
torch.save(model.state_dict(), 'vae_oversampled_cnn.pth')
print('saved model to vae_oversampled_cnn.pth')