...
train_labels = pd.read_csv('../../data/severstal/train_split_gan_augmented.csv')
...
train_ds = SeverstalDataset(
    '../../data/severstal/train_split_gan_augmented.csv',
    '../../data/severstal/train_images',
    synthetic_dir='../../data/severstal/gan_synthetic'
)
...
torch.save(model.state_dict(), 'gan_oversampled_cnn.pth')
print('saved model to gan_oversampled_cnn.pth')